...
namespace System.Rendering.Effects.Shaders
{
    ...
    {
        public static PrimitiveSet Empty { get; private set; }

        static PrimitiveSet() { Empty = new EmptyPrimitiveSet(); }

        private Dictionary<MemberInfo, ShaderMember> membersMap = new Dictionary<MemberInfo, ShaderMember>();
        private Dictionary<ShaderMember, MemberInfo> shadersMap = new Dictionary<ShaderMember, MemberInfo>();
        ...
        public string AssemblyName
        {
            get
            {
                string assemblyName = typeof(IRender).AssemblyQualifiedName;
    ...
    internal class EmptyPrimitiveSet : PrimitiveSet
    {
    }
