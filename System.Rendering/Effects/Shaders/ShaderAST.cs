...
namespace System.Rendering.Effects.Shaders
{
    ...
    public class ShaderProgramAST : ShaderNodeAST
    {
        ...
        public static ShaderProgramAST Join(ShaderProgramAST first, ShaderProgramAST second)
        {
            ...
            newMain.Body = GetJoinFunctionBody(first, second, newMain, inout);
        ...
        public void RestrictInOutSemantics(IEnumerable<Semantic> supportedInSemantics, IEnumerable<Semantic> supportedOutSemantics)
        {
            ...
            if (!inOk || !outOk)
            {
                ...
                newMain.Body = GetRestrictedFunctionBody(newMain, this, newInStruct, newOutStruct);
        ...
        private static BlockStatementAST GetJoinFunctionBody(ShaderProgramAST first, ShaderProgramAST second, FunctionDeclarationAST newMain, StructDeclarationAST newIn)
        {
            BlockStatementAST result = new BlockStatementAST();

            BlockStatementAST firstCallCode = GetShaderMainCallBody(first, newMain, newIn);
            BlockStatementAST secondCallCode = GetShaderMainCallBody(second, newMain, newIn);
        ...
        private static BlockStatementAST GetRestrictedFunctionBody(FunctionDeclarationAST newMain, ShaderProgramAST program, StructDeclarationAST newIn, StructDeclarationAST newOut)
        {
            BlockStatementAST result = new BlockStatementAST();
            ...
            BlockStatementAST updateInShaderCode = GetUpdateValueCode(new ParameterExpressionAST { Parameter = newMain.Parameters[0].Parameter }, new LocalExpressionAST { Local = inShader.Local }, program, newIn, program.In);
            ...
            BlockStatementAST updateOutValueCode = GetUpdateValueCode(new LocalExpressionAST { Local = outFirstShader.Local }, new LocalExpressionAST { Local = outValue.Local }, program, program.Out, newOut);
        ...
        private static BlockStatementAST GetShaderMainCallBody(ShaderProgramAST shader, FunctionDeclarationAST newMain, StructDeclarationAST newIn)
        {
            BlockStatementAST result = new BlockStatementAST();
            //VSIn in;
            LocalDeclarationAST inShader = new LocalDeclarationAST() { Type = shader.In.Type };
            //Actualizar los campos comunes entre la entrada de newMain y la entrada del main del shader
            BlockStatementAST updateInShaderCode = GetUpdateValueCode(new ParameterExpressionAST { Parameter = newMain.Parameters[0].Parameter }, new LocalExpressionAST { Local = inShader.Local }, shader, newIn, shader.In);
            ...
            BlockStatementAST updateOutValueCode = GetUpdateValueCode(new LocalExpressionAST { Local = outFirstShader.Local }, new ParameterExpressionAST { Parameter = newMain.Parameters[0].Parameter }, shader, shader.Out, newIn);
        ...
        private static BlockStatementAST GetUpdateValueCode(VariableExpressionAST origin, VariableExpressionAST destiny, ShaderProgramAST program, StructDeclarationAST originDeclaration, StructDeclarationAST destinyDeclaration)
        {
            BlockStatementAST result = new BlockStatementAST();
    ...
    public sealed class StructDeclarationAST : TypeDeclarationAST
    {
        ...
        public FieldDeclarationAST GetFieldBySemantic(Semantic semantic)
        {
            if (semantic == null)
                return null;
    ...
    public sealed class FunctionDeclarationAST : DeclarationAST
    {
        ...
        public ShaderFunction Function { get { return _Function; } }
    ...
    public sealed class FunctionExpressionAST : CallExpressionAST
    {
        ...
        {
            get { return (ShaderFunction)Member; }
            set { Member = value; }
        }
    ...
    {
        public ConstructionExpressionAST() : base ()
        {
        }
