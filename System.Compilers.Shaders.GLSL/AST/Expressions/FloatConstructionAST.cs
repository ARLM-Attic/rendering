...
{
  public class FloatConstructionAST : ConstructionExpressionAST
  {
    public FloatConstructionAST()
    {
    }

    public FloatConstructionAST(int line, int column)
      : base(line, column)
    {
    }

    public FloatConstructionAST(string name, IEnumerable<ExpressionAST> args, int line, int column)
