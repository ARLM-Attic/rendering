...
{
  public class BoolConstructionAST : ConstructionExpressionAST
  {
    public BoolConstructionAST()
    {
    }

    public BoolConstructionAST(int line, int column)
      : base(line, column)
    {
    }

    public BoolConstructionAST(string name, IEnumerable<ExpressionAST> args, int line, int column)
