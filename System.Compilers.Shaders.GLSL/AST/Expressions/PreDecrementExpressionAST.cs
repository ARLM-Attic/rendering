...
{
  public class PreDecrementExpressionAST : UnaryExpressionAST
  {
    protected PreDecrementExpressionAST()
    {
    }

    protected PreDecrementExpressionAST(int line, int column)
      : base(line, column)
    {
    }

    public PreDecrementExpressionAST(ExpressionAST postfix, int line, int column)
